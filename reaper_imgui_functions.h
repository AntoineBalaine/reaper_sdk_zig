...
namespace ImGui {
  ...
  REAIMGUIAPI_EXTERN int DragDropFlags_SourceAutoExpirePayload;
  ...
  REAIMGUIAPI_EXTERN details::function<void(ImGui_DrawList* draw_list, ImGui_Font* font, double font_size, double pos_x, double pos_y, int col_rgba, const char* text, details::optional<double> wrap_widthInOptional, details::optional<double> cpu_fine_clip_rect_xInOptional, details::optional<double> cpu_fine_clip_rect_yInOptional, details::optional<double> cpu_fine_clip_rect_wInOptional, details::optional<double> cpu_fine_clip_rect_hInOptional)> DrawList_AddTextEx;
  ...
  REAIMGUIAPI_EXTERN details::function<ImGui_Image*(const char* data, int data_sz), true> CreateImageFromMem;
  ...
  REAIMGUIAPI_EXTERN int Mod_Shortcut;
  ...
  REAIMGUIAPI_EXTERN int Col_TabActive;
  REAIMGUIAPI_EXTERN int Col_TabHovered;
  REAIMGUIAPI_EXTERN int Col_TabUnfocused;
  REAIMGUIAPI_EXTERN int Col_TabUnfocusedActive;
  ...
  REAIMGUIAPI_EXTERN details::function<bool(ImGui_Context* ctx, const char* str_id, int column, details::optional<int> flagsInOptional, details::optional<double> outer_size_wInOptional, details::optional<double> outer_size_hInOptional, details::optional<double> inner_widthInOptional), true> BeginTable;
...
void ImGui::init(void *(*plugin_getapi)(const char *))
{
  ...
  DragDropFlags_SourceAutoExpirePayload = details::get_enum(get_func(version, "DragDropFlags_SourceAutoExpirePayload")); details::check_error();
  ...
  Mod_Shortcut = details::get_enum(get_func(version, "Mod_Shortcut")); details::check_error();
  ...
  Col_TabActive = details::get_enum(get_func(version, "Col_TabActive")); details::check_error();
  Col_TabHovered = details::get_enum(get_func(version, "Col_TabHovered")); details::check_error();
  Col_TabUnfocused = details::get_enum(get_func(version, "Col_TabUnfocused")); details::check_error();
  Col_TabUnfocusedActive = details::get_enum(get_func(version, "Col_TabUnfocusedActive")); details::check_error();
